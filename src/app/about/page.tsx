...
import imageMattBankston from '@/images/team/matt-bankston.jpg'
import imageScottPhelps from '@/images/team/scott-phelps.jpg'
    ...
    people: [
      {
        name: 'Matt Bankston',
        role: 'Co-Founder',
        image: { src: imageMattBankston },
      },
      {
        name: 'Scott Phelps',
        role: 'Senior Developer / Co-Founder',
        image: { src: imageScottPhelps },
      },
    ],
  },
]
    ...
    <>
      <PageIntro eyebrow="About us" title="Our strength is collaboration">
        ...
        <div className="mt-10 max-w-2xl space-y-6 text-base">
          <p>
            Coastal Sites was started by two friends who noticed that developer
