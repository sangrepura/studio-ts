  ...
  return (
    <label className="flex gap-x-3">
      <input
        type="radio"
        {...props}
        className="size-6 flex-none appearance-none rounded-full border border-slate-950/20 outline-none checked:border-[0.5rem] checked:border-slate-950 focus-visible:ring-1 focus-visible:ring-slate-950 focus-visible:ring-offset-2"
      />
