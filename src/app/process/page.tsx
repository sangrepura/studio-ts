    ...
    <Section title="Discover" image={{ src: imageWhiteboard }}>
      <div className="space-y-6 text-base text-slate-600">
        <p>
          ...
          <strong className="font-semibold text-slate-950">needs</strong> and
        ...
        <p>
          ...
          <strong className="font-semibold text-slate-950">business</strong>{' '}
          accounts — handing that information over to our forensic accounting
          team.
        </p>
        <p>
          Once the full audit is complete, we report back with a comprehensive{' '}
          <strong className="font-semibold text-slate-950">plan</strong> and,
    ...
    <Section title="Deliver" image={{ src: imageMeeting, shape: 2 }}>
      <div className="space-y-6 text-base text-slate-600">
        <p>
          ...
          <strong className="font-semibold text-slate-950">requirements</strong>
          . This allows us to increase the budget a final time before launch.
        </p>
        <p>
          Despite largely using pre-built components, most of the{' '}
          <strong className="font-semibold text-slate-950">progress</strong> on
        ...
        <p>
          ...
          <strong className="font-semibold text-slate-950">maintenance</strong>{' '}
          retainer.
        </p>
      </div>
  ...
  return (
    <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
      <div className="absolute inset-x-0 top-0 -z-10 h-[884px] overflow-hidden rounded-t-4xl bg-gradient-to-b from-slate-50">
        <GridPattern
          className="absolute inset-0 size-full fill-slate-100 stroke-slate-950/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
          yOffset={-270}
        />
      </div>
